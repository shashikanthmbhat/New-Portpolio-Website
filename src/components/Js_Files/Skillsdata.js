...
export const skillsBI = [
    {
        name: "PowerBI",
        icon_Dark: Powerbi_Dark,
        icon_Light: Powerbi_Light,
        level: 95,
        color: "#f2c811",
    },
    {
        name: "Excel",
        icon_Dark: Excel_Dark,
        icon_Light: Excel_Light,
        level: 95,
        color: "#185c37",
    },
    {
    ...
    },
    {
        name: "SPSS",
        icon_Dark: SPSS_Dark,
        icon_Light: SPSS_Light,
        level: 85,
        color: "#d50b38",
    },
    {
        name: "Python",
        icon_Dark: Python_Dark,
        icon_Light: Python_Light,
        level: 85,
        color: "#264d6f",
    },
];
...
export const skillsDM = [
    {
        name: "Power BI DAX",
        icon_Dark: Daxdm_Dark,
        icon_Light: Daxdm_Light,
        level: 95,
        color: "#cca300",
    },
    {
    ...
    },
    {
        name: "ETL",
        icon_Dark: Etl_Dark,
        icon_Light: Etl_Light,
        level: 90,
        color: "#00167a",
    },
    {
        name: "Data Warehousing",
        icon_Dark: DataWH_Dark,
        icon_Light: DataWH_Light,
        level: 90,
        color: "#7a0000",
    },
];
...
export const skillsPL = [
    {
        name: "DAX",
        icon_Dark: Daxpl_Dark,
        icon_Light: Daxpl_Light,
        level: 95,
        color: "#f2c811",
    },
    {
    ...
    },
    {
        name: "R Programming",
        icon_Dark: Rpl_Dark,
        icon_Light: Rpl_Light,
        level: 90,
        color: "#2369bd",
    },
    {
        name: "C #",
        icon_Dark: Csharp_Dark,
        icon_Light: Csharp_Light,
        level: 85,
        color: "#782379",
    },
    {
...
export const skillsDB = [
    {
        name: "My SQL",
        icon_Dark: Mysql_Dark,
        icon_Light: Mysql_Light,
        level: 95,
        color: "#00758f",
    },
    {
...
export const stats = [
    ...
    { id: 3, name: "Biostatistics" },
    { id: 4, name: "Data Insights" },
    { id: 5, name: "Designs of Experiments (DOE)" },
    { id: 6, name: "Decision Trees" },
    { id: 7, name: "Quality control tools" },
    { id: 8, name: "Multivariate data analysis" },
    { id: 9, name: "Operational research" },
    { id: 10, name: "Regression Analysis" },
    { id: 11, name: "Clustering Techniques" },
    { id: 12, name: "Generalized Linear Model" },
    { id: 13, name: "Research Methodology" },
    { id: 14, name: "Artificial Intelligence" },
    { id: 15, name: "Econometrics" },
    { id: 16, name: "Psychometric" },
    { id: 17, name: "Sampling" },
    { id: 18, name: "Data Science" },
    { id: 19, name: "Classification Algorithms" },
    { id: 20, name: "Predictive Analytic" },
    { id: 21, name: "Machine Learning" },
    { id: 22, name: "Data Mining" },
    { id: 23, name: "Bigdata Analytics" },
    { id: 24, name: "Natural Language Processing (NLP)" },
    { id: 25, name: "Supervised Learning." },
    { id: 26, name: "LPP" },
    { id: 27, name: "Unsupervised Learning" },
    { id: 28, name: "Reinforcement Learning" },
    { id: 29, name: "Deep Learning" },
    { id: 30, name: "Ensemble Methods" },
    { id: 31, name: "ARIMA" },
    { id: 32, name: "Stochastic Optimization" },
    { id: 33, name: "Dynamic Programming" },
    { id: 34, name: "Queueing Theory" },
];
