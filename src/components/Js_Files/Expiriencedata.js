...
export const Expiriences = [

    {
        ...
        disc: [
            "Developed interactive Power BI dashboards and reports to visualize key business metrics, improving decision-making efficiency.",
...

    {
        ...
        disc: [
            "Define and document all active and inactive channels for data collection, investigating the possibilities of linking fields, merging tables and archiving legacy information in compressed formats",
