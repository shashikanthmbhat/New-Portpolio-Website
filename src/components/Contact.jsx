...
const Contact = ( {darkMode} ) => {
    ...
    const contactInfo = [
        {id: 1, 
         name: 'Email',
         icon: FaEnvelope,
         alt: 'shashikanthmbhat@mail.com',
         href: 'mailto:shashikanthmbhat@mail.com',
    },
      {id: 2, 
         name: 'WhatWhatsApp',
         icon: FaWhatsapp,
                        ...
                        <div data-aos='fade-right'
                            ...
                            <div className="flex flex-col space-y-6 indent-4 gap-1">
                                {contactInfo.map((info) => {
                                    // Dynamic extraction of the designated icon component
                                        ...
                                        >
                                            ...
                                            <div className="px-4 pb-2">
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="_noreferrer"
                                                    className={`group relative w-full px-6 py-2 block rounded-lg text-sm text-center font-medium
                                                ...
                                                >
                                                    ...
                                                    {/* The Button Text Content (Elevated above the gradient layer) */}
